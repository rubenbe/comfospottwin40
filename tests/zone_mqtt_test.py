...
class TestZoneMqtt(unittest.TestCase):
    ...
    def test_get_mqttconfig_topic_zone(self):
        ...
        self.assertEqual(
            v,
            """{"name": "Comfospot40 Zone 1 Fan", "state_topic": "comfospot40_zone1_fan/state", "command_topic": "comfospot40_zone1_fan/on/set", "state_value_template": "{{ value_json.state }}", "direction_state_topic": "comfospot40_zone1_fan/state", "direction_command_topic": "comfospot40_zone1_fan/direction/set", "direction_value_template": "{{ value_json.direction }}", "oscillation_state_topic": "comfospot40_zone1_fan/state", "oscillation_command_topic": "comfospot40_zone1_fan/oscillation/set", "oscillation_value_template": "{{ value_json.oscillation }}", "percentage_state_topic": "comfospot40_zone1_fan/state", "percentage_command_topic": "~/speed/percentage", "percentage_value_template": "{{ value_json.percentage }}", "preset_mode_state_topic": "comfospot40_zone1_fan/state", "preset_mode_command_topic": "comfospot40_zone1_fan/preset/set", "preset_mode_value_template": "{{ value_json.preset }}", "preset_modes": ["low", "mid", "high", "max"], "qos": 0, "payload_on": "true", "payload_off": "false", "payload_oscillation_on": "true", "payload_oscillation_off": "false", "speed_range_min": 16, "speed_range_max": 128, "unique_id": "comfospot40_zone1_fan"}""",
        )
