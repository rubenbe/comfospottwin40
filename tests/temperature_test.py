...
class TestTemperature(unittest.TestCase):
    ...
    def test_mqtt_config1(self):
        t = Temperature()
        c = t.mqtt_config("mqttprefix1", 0, "recycled")
        self.assertEqual(
            c,
            {
                ...
                "state_topic": "mqttprefix1/zones/zone0/recycled_temperature",
    ...
    def test_mqtt_config2(self):
        t = Temperature()
        c = t.mqtt_config("mqttprefix2", 1, "inside")
        self.assertEqual(
            c,
            {
                ...
                "device_class": "temperature",
                "state_class": "measurement",
                "state_topic": "mqttprefix2/zones/zone1/inside_temperature",
                "temperature_unit": "celcius",
            },
        )
